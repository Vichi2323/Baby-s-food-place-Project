...
import '../FreshAndNew/FreshAndNew.css'
...
const starOne = (_id) => {
    ...
    return (
        <div className="whole-page">
            ...
            <h1 className="title-fresh">Most Popular</h1><hr id="hr7" />
            </div>
            <div className="whole-map">
            {popular && popular?popular.map((recipe, index) => {
                const goToPopUp = () => {
                    history.push({
                        pathname: "/popup",
                        search: "?query=abc",
                ...
                return(
                    <div key={index} className="div-key">
