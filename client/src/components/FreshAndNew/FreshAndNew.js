...
const FreshAndNew = () => {             
    ...
    const getLatest = () => {
        fetch("http://localhost:10004/api/v1/recipes/latest")
        .then(res => res.json())
    ...
    return (
        <div className="whole-page">
            <div className="title-div">
                <h1 className="title-fresh">Fresh & new</h1><hr id="hr7" />
                </div>
                ...
                return(
                    <div key={i} className="div-key">
                        ...
                        <div className="div-belowimage">
                            <h6 className="orange-title">{recipe.recipe_title}</h6>
                            ...
                            <button className="arrows-button" onClick={goToPopUp}>    
                             <img className="icon-arrow" src={icon_arrows_white} alt="icon-arrow"/>
                             </button>
